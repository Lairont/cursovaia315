        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_promo_codes_discounts_discount_id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_order_status", "\"status\" IN ('pending', 'paid', 'shipped', 'completed', 'cancelled')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_delivery_status", "\"status\" IN ('pending', 'in_progress', 'delivered')");
                    table.ForeignKey(
                        name: "FK_deliveries_delivery_methods_delivery_method_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    method_id = table.Column<int>(type: "integer", nullable: true),
                    status = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("chk_payment_status", "\"status\" IN ('pending', 'paid', 'failed')");
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_payments_payment_methods_method_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_promo_codes_discount_id",
                table: "promo_codes",
                column: "discount_id");
